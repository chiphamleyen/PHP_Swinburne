...
<body>
    ...
    <!-- Display post form  -->
    <div class="postform">
        <h2>Job Vacancy Posting Form</h2>

        <form action="postjobprocess.php" method="POST">
            <div class="form-group row">
                <label class="col-sm-3 col-form-label" for="position_id">Position ID:</label>
                <div class="col-sm-8">
                    <input type="text" id="position_id" placeholder="P0001" name="position_id">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <textarea rows="3" cols="30" maxlength="260" wrap="hard" name="description"></textarea>
                </div>
            </div>

            <div class="form-group row">
                <label class="col-sm-3 col-form-label" for="closing_date">Closing date:</label>
                <div class="col-sm-8">
